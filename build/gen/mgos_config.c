...
const struct mgos_conf_entry mgos_config_schema_[126] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 125},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "mcp23xxx", .offset = offsetof(struct mgos_config, mcp23xxx), .num_desc = 2},
  {.type = CONF_TYPE_INT, .key = "i2caddr", .offset = offsetof(struct mgos_config, mcp23xxx.i2caddr)},
  {.type = CONF_TYPE_INT, .key = "int_gpio", .offset = offsetof(struct mgos_config, mcp23xxx.int_gpio)},
