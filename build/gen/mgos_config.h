 ...
 * Command: /data/fwbuild-volumes/2.14.0/apps/i2c/esp8266/build_contexts/build_ctx_976188573/deps/modules/mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.14.0/apps/i2c/esp8266/build_contexts/build_ctx_976188573/build/gen/ /data/fwbuild-volumes/2.14.0/apps/i2c/esp8266/build_contexts/build_ctx_976188573/deps/modules/mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.14.0/apps/i2c/esp8266/build_contexts/build_ctx_976188573/build/gen/mos_conf_schema.yml
 */
...
struct mgos_config {
  ...
  const char * conf_acl;
  struct mgos_config_mcp23xxx mcp23xxx;
...
/* mcp23xxx */
#define MGOS_CONFIG_HAVE_MCP23XXX
#define MGOS_SYS_CONFIG_HAVE_MCP23XXX
const struct mgos_config_mcp23xxx * mgos_config_get_mcp23xxx(struct mgos_config *cfg);
static inline const struct mgos_config_mcp23xxx * mgos_sys_config_get_mcp23xxx(void) { return mgos_config_get_mcp23xxx(&mgos_sys_config); }

/* mcp23xxx.i2caddr */
#define MGOS_CONFIG_HAVE_MCP23XXX_I2CADDR
#define MGOS_SYS_CONFIG_HAVE_MCP23XXX_I2CADDR
int mgos_config_get_mcp23xxx_i2caddr(struct mgos_config *cfg);
static inline int mgos_sys_config_get_mcp23xxx_i2caddr(void) { return mgos_config_get_mcp23xxx_i2caddr(&mgos_sys_config); }
void mgos_config_set_mcp23xxx_i2caddr(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mcp23xxx_i2caddr(int v) { mgos_config_set_mcp23xxx_i2caddr(&mgos_sys_config, v); }

/* mcp23xxx.int_gpio */
#define MGOS_CONFIG_HAVE_MCP23XXX_INT_GPIO
#define MGOS_SYS_CONFIG_HAVE_MCP23XXX_INT_GPIO
int mgos_config_get_mcp23xxx_int_gpio(struct mgos_config *cfg);
static inline int mgos_sys_config_get_mcp23xxx_int_gpio(void) { return mgos_config_get_mcp23xxx_int_gpio(&mgos_sys_config); }
void mgos_config_set_mcp23xxx_int_gpio(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mcp23xxx_int_gpio(int v) { mgos_config_set_mcp23xxx_int_gpio(&mgos_sys_config, v); }
